#!/bin/bash
# ╔══════════════════════════════════════════════════════════════════╗
# ║   ARC PORTAL v3.0 — STARK INDUSTRIES EDITION                    ║
# ║   Working captive portal with auto-browser open                 ║
# ╚══════════════════════════════════════════════════════════════════╝
...
rsn_pairwise=CCMP
EOF
    echo -e "${GREEN}[✓]${NC} AP Configuration created"
}
...
start_services() {
    ...
    if pgrep -x "hostapd" > /dev/null; then
        echo -e "${GREEN}[✓]${NC} Access Point ACTIVE: ${ORANGE}$AP_SSID${NC}"
    else
...
show_status() {
    ...
    echo -e "${CYAN}╠════════════════════════════════════════════════════════════════╣${NC}"
    echo -e "${CYAN}║${NC}  ${GOLD}Network:${NC}    $AP_SSID                                    ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC}  ${GOLD}Password:${NC}   $AP_PASS                                    ${CYAN}║${NC}"
